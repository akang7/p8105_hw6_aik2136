...
![](p8105_hw6_aik2136_files/figure-markdown_github/model_2-1.png)
...
![](p8105_hw6_aik2136_files/figure-markdown_github/comparing_models_2-1.png)
...
|:-------------------|----------:|
| my\_model          |   280.9689|
| main\_model        |   331.1496|
| interaction\_model |   288.2706|

The above plot visualizes violin plots for the RMSE of my proposed model, the main effects model, and the interaction model. Based on these plots, I would choose my model over the other two. However, I would consider adding the interaction terms that were specified in the interaction model.
